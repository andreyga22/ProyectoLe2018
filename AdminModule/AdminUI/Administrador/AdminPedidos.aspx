...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-12">
            <asp:GridView ID="GridView1" runat="server" class="table table-striped table-bordered table-responsive-lg" BorderStyle="None" BorderWidth="0px">
            </asp:GridView>
        </div>
              </div>
        <br/>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col col-12 align-self-start">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label14" runat="server" Text="Busqueda por ID"></asp:Label>
                ...
                <div class="row align-items-center">
                    <div class="col col-12 align-self-start">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox class="form-control" ID="TextBox2" runat="server"></asp:TextBox><asp:RequiredFieldValidator ID="rfvEmailInsertar" runat="server" ErrorMessage="Campo requerido" ControlToValidate="TextBox2"></asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group">
